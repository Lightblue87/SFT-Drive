...
- **Ollama-Erreichbarkeit**: rein lokal auf demselben Mac, oder auch ein
  ...
  „localhost" anbieten.
- **Gebündelte Planungs-RPCs** (§40.5) und die additiven Hotel-Felder aus
  §36 werden vor Implementierung gegen das dann aktuelle Schema entworfen.
  Jede Schemaänderung wird einzeln versioniert, lokal gegen eine echte
  `authenticated`-Rolle getestet und erst nach produktiver Migration genutzt.
